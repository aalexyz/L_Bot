...
public class HardwareMapping {
    ...
    public HardwareMapping(DcMotor frontLeftMotor, DcMotor backLeftMotor, DcMotor frontRightMotor, DcMotor backRightMotor, IMU imu) {
    ...
    public static HardwareMapping from(HardwareMap map) {
        return new HardwareMapping(map.dcMotor.get(FRONT_LEFT_MOTOR),
                ...
                map.dcMotor.get(BACK_RIGHT_MOTOR), map.get(IMU.class, "imu"));
    }
}
